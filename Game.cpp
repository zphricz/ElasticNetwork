...
static double repel_factor = 100.0;
static double attract_factor = 1.0E-4;
static double damp_factor = .5;
...
void Game::set_scale_variables() {
    double right_bound = net.nodes[0]->pos.x;
    double left_bound = net.nodes[0]->pos.x;
    double up_bound = net.nodes[0]->pos.y;
    double down_bound = net.nodes[0]->pos.y;
